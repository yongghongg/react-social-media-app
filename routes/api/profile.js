...
router.post('/', passport.authenticate('jwt', {
  ...
  // Get fields
  const profileFields = {};
  profileFields.user = req.user.id; // req.user.id comes from the token
...
// @desc    Let user add experience to profile
// @access  Private
...
// @desc    Let user add education to profile
// @access  Private
...
// @desc    Let user delete experience from profile
// @access  Private
...
// @desc    Let user delete education from profile
// @access  Private
